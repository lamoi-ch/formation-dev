...
import static net.komportementalist.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
...
import net.komportementalist.config.audit.AuditEventConverter;
import net.komportementalist.domain.PersistentAuditEvent;
