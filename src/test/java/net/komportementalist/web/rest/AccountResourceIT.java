...
import static net.komportementalist.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import net.komportementalist.config.Constants;
import net.komportementalist.domain.User;
import net.komportementalist.repository.AuthorityRepository;
import net.komportementalist.repository.UserRepository;
import net.komportementalist.security.AuthoritiesConstants;
import net.komportementalist.service.UserService;
import net.komportementalist.service.dto.PasswordChangeDTO;
import net.komportementalist.service.dto.UserDTO;
import net.komportementalist.web.rest.vm.KeyAndPasswordVM;
import net.komportementalist.web.rest.vm.ManagedUserVM;
