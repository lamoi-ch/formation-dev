...
describe('UserExtra e2e test', () => {
  ...
  it('should load UserExtras', async () => {
    ...
    expect(await userExtraComponentsPage.getTitle()).to.eq('komportementalistApp.userExtra.home.title');
  ...
  it('should load create UserExtra page', async () => {
    ...
    expect(await userExtraUpdatePage.getPageTitle()).to.eq('komportementalistApp.userExtra.home.createOrEditLabel');
  ...
  it('should create and save UserExtras', async () => {
    ...
    await promise.all([userExtraUpdatePage.setNameInput('name'), userExtraUpdatePage.userCategorySelectLastOption()]);

    expect(await userExtraUpdatePage.getNameInput()).to.eq('name', 'Expected Name value to be equals to name');
  ...
  it('should delete last UserExtra', async () => {
    ...
    expect(await userExtraDeleteDialog.getDialogTitle()).to.eq('komportementalistApp.userExtra.delete.question');
